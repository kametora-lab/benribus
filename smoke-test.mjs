...
await page.fill("#fromInput", "奄美空港");
await page.keyboard.press("Enter");
await page.fill("#toInput", "奄美市役所前");
await page.keyboard.press("Enter");
...
await page.waitForFunction(() => document.querySelector("#routeUrl")?.textContent === "https://shimabus.busplus.jp/main/1-44");
...
if (restoredRouteName !== "奄美空港 → 奄美市役所前") {
...
if (frameSrc !== "https://shimabus.busplus.jp/main/1-44") {
